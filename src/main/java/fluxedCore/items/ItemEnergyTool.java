...
public class ItemEnergyTool extends ItemSpade implements IEnergyContainerItem {
	...
	public ItemEnergyTool(ItemTool axe, String overlay) {
		super(axe.func_150913_i());
		name = axe.getUnlocalizedName();
		toolMaterial = axe;
		maxCapacity = 10000;
	...
	public boolean onBlockDestroyed(ItemStack itemstack, World world, Block block, int x, int y, int z,
		...
		if (getEnergyStored(itemstack) >= 125
				&& toolMaterial.onBlockDestroyed(new ItemStack(toolMaterial), world, block, x, y, z, ent)) {
	...
	public boolean onBlockStartBreak(ItemStack itemstack, int x, int y, int z, EntityPlayer player) {
		if (getEnergyStored(itemstack) >= 125
				&& toolMaterial.onBlockStartBreak(new ItemStack(toolMaterial), x, y, z, player)) {
			extractEnergy(itemstack, 125, false);
		}
		return false;
	}
	...
	public void registerIcons(IIconRegister icon) {
		overlay = icon.registerIcon(overlayPath);
	...
	public float getDigSpeed(ItemStack stack, Block block, int meta) {
		...
		return toolMaterial.getDigSpeed(stack, block, meta) + (toolMaterial.getDigSpeed(stack, block, meta) / 3);
	}
	...
	public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_,
		...
		return toolMaterial.onItemUse(p_77648_1_, p_77648_2_, p_77648_3_, p_77648_4_, p_77648_5_, p_77648_6_,
				p_77648_7_, p_77648_8_, p_77648_9_, p_77648_10_);
	}

	@Override
	public void onUsingTick(ItemStack stack, EntityPlayer player, int count) {
		toolMaterial.onUsingTick(stack, player, count);
	}

	@Override
	public int getMaxItemUseDuration(ItemStack p_77626_1_) {
		return toolMaterial.getMaxItemUseDuration(p_77626_1_);
	}

	public EnumAction getItemUseAction(ItemStack p_77661_1_) {
		return toolMaterial.getItemUseAction(p_77661_1_);
	}

	@Override
	public EnumRarity getRarity(ItemStack p_77613_1_) {
		return toolMaterial.getRarity(p_77613_1_);
	}
