...
public class ItemEnergyShovel extends ItemSpade implements IEnergyContainerItem {
	private int maxCapacity = 10000;

	public ItemEnergyShovel(ItemTool shovel) {
		super(shovel.func_150913_i());
		name = shovel.getUnlocalizedName();
		toolMaterial = shovel;
		maxCapacity = 10000;
	...
	public void registerIcons(IIconRegister icon) {
		overlay = icon.registerIcon(Reference.MOD_ID + ":energyShovelOverlay");
