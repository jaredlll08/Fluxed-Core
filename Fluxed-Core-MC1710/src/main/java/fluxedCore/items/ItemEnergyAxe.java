...
public class ItemEnergyAxe extends ItemSpade implements IEnergyContainerItem {

	private int maxCapacity = 10000;

	public ItemEnergyAxe(ItemTool axe) {
	...
	public void registerIcons(IIconRegister icon) {
		overlay = icon.registerIcon(Reference.MOD_ID + ":energyAxeOverlay");
